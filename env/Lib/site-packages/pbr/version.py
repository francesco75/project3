...
class SemanticVersion(object):
    ...
    def _sort_key(self):
        ...
        # - dev.txt==None is after all other devs, so we use sys.maxsize there.
        # - unqualified dev.txt releases come before any pre-releases.
        # So we do:
        # (major, minor, patch) - gets the major grouping.
        # (0|1) unqualified dev.txt flag
        # (a/b/rc/z) - release segment grouping
        # pre-release level
        # dev.txt count, maxsize for releases.
    ...
    def from_pip_string(klass, version_string):
        ...
        Pre pbr-semver dev.txt versions like 0.10.1.3.g83bef74 will be parsed but
    ...
    def _from_pip_string_unsafe(klass, version_string):
        ...
        # decimals first (keep pre-release and dev.txt/hashes to the right)
        ...
        if remainder_starts_with_int:
            # old dev.txt format - 0.1.2.3.g1234
            ...
            while remainder:
                ...
                if component.startswith('dev.txt'):
    ...
    def version_tuple(self):
        ...
        candidatedev values. When they are present the dev.txt count is used
        to provide the serial.
        - a/b/rc take precedence.
        - if there is no pre-release version the dev.txt version is used.
        - serial is taken from the dev.txt/a/b/c component.
        - final non-dev.txt versions never get serials.
        """
